!function (e) {
    ...
    tt.defineMode("javascript", function (e, l) {
        var t, r, n, a, i, o, d = e.indentUnit, p = l.statementIndent, c = l.jsonld, s = l.json || c, u = l.typescript,
        ...
        function A(e, t) {
            ...
            if (!(r < 0)) {
                ...
                for (var a = 0, i = !1, o = r - 1; 0 <= o; --o) {
                    ...
                    } else if (3 <= s && s < 6) ++a; else if (f.test(c)) i = !0; else if (/["'\/`]/.test(c)) for (; ; --o) {
                        if (0 == o) return;
        ...
        function _(e) {
            var t = I.state;
            if (I.marked = "def", t.context) if ("var" == t.lexical.info && t.context && t.context.block) {
        ...
        return H.lex = B.lex = !0, {
            ...
            indent: function (e, t) {
                ...
                if (!/^\s*else\b/.test(t)) for (var i = e.cc.length - 1; 0 <= i; --i) {
                    var o = e.cc[i];
                    if (o == H) a = a.prev; else if (o != $e) break
                }
